-------------------------
-- CREDIT : Louis
-- BASE : https://forum.fivem.net/t/release-vehicle-shop-by-arturs/1783
-------------------------
local vehshop = {
	opened = false,
	title = "Rent a Car",
...
function ShowVehshopBlips(bool)
	if bool and #vehshop_blips == 0 then
		for station,pos in pairs(vehshop_locations) do
			...
			AddTextComponentString('Location de Vehicule')
			...
			while #vehshop_blips > 0 do
				...
				for i,b in ipairs(vehshop_blips) do
					if IsPlayerWantedLevelGreater(GetPlayerIndex(),0) == false and vehshop.opened == false and IsPedInAnyVehicle(LocalPed(), true) == false and  GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(LocalPed())) < 5 then
						...
						drawTxt('Appuyez sur ~r~ENTRER~s~. Pour Choisir votre vehicule',0,1,0.5,0.8,0.6,255,255,255,255)
						currentlocation = b
						inrange = true
					end
				end
